...
if option == "Record sound":
    ...
    # if record_button:
        ...
        st.markdown("**Audio nettoyé avec CMGAN**")
    ...
    snr = st.slider("**Choisissez le rapport Signal-Bruit (SNR)**", -20, 20, 7)
